...
public class StytleAdapter extends RecyclerView.Adapter<StytleAdapter.HotVH> {
    private List<ShouyeBean.ResultBean.MlssBean.CommodityListBeanXX> listHot;
    private Context context;

    public StytleAdapter(List<ShouyeBean.ResultBean.MlssBean.CommodityListBeanXX> listHot, Context context) {
    ...
    private ProductCallBacks productCallBack;

    public void setProductCallBack(ProductCallBacks productCallBack) {
