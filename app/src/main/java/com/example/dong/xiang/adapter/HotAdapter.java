...
public class HotAdapter extends RecyclerView.Adapter<HotAdapter.HotVH> {
    private List<ShouyeBean.ResultBean.RxxpBean.CommodityListBean> listHot;
    private Context context;

    public HotAdapter(List<ShouyeBean.ResultBean.RxxpBean.CommodityListBean> listHot, Context context) {
    ...
    public HotVH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view =  LayoutInflater.from(context).inflate(R.layout.home_hontone,viewGroup,false);
