...
public class LalbeAdapter extends RecyclerView.Adapter<LalbeAdapter.HotVH> {
    private List<LableBean.ResultBean> listHot;
    private Context context;

    public LalbeAdapter(List<LableBean.ResultBean> listHot, Context context) {
    ...
    public HotVH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view =  LayoutInflater.from(context).inflate(R.layout.labe_item,viewGroup,false);
